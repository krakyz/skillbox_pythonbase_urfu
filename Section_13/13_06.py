...
# пор, пока мы не сочтём такой маятник остановившимся. Напишите программу, определяющую, сколько раз качнётся
...
print(f'Маятник считается остановившимся через {oscillation_count} колебаний')
