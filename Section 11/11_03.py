...
# показать сколько процентов уже скачалось, чтобы он мог решить пойти заварить чаю, или подождать у экрана
# компьютера. Обновления игры всегда занимают разное количество мегабайт, да и скорость интернет-соединения у игроков
# разная.
#
...
speed = int(input('Укажите скорость вашего соединения (МБ/с): '))
print()
...
for second in range(1, time + 1):
    if second == time:
        ...
        print(f'Прошло {second} сек. Скачано {speed * second} из {size} МБ ({round(100 / (size / speed * second))}%)')
